...
import { ACTION_USER, TYPES_USER } from '@redux/types/users';
...
const login = (data: any) => async (dispatch: Dispatch<ACTION_AUTHENTICATION>) => {
    try{
        const res = await api.post(`/authentication/email`, data);
        dispatch({
