...
const Login = () => {
    ...
    const initalState: Validation = { email: "", code: "", name: `user-${generateid()}`};
    ...
    async function callback(){
      ...
      if(authState.status.login !== "success") await dispatch(authentication.login({...values}));
    };
        ...
        <Flex flex='center' style={{"marginTop": "5rem"}}>
            {
                ...
                ?
                <Form onSubmit={onSubmit} loading={loading} width={280} buttonClr={values.code ? "main" : "none"}>
                    <>
                ...
                :
                <Form onSubmit={onSubmit} loading={loading} width={350} buttonClr={values.email ? "main" : "none"}>
                    <Input label1="Email address" label2={errors.email} error placeholder="..." 
